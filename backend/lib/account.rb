...
class Account
  ...
  def self.create(name, email, cpf, is_passenger, is_driver, car_plate = nil)
    ...
    Account.new(account_id, name, email, cpf, is_passenger, is_driver, date, is_verified, verification_code, car_plate)
  end
end
